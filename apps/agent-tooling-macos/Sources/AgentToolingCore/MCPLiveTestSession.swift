...
enum MCPResponseReader {
    ...
    static func annotations(_ value: JSONValue?) -> MCPToolAnnotations? {
    ...
    static func tools(in result: [String: JSONValue]) throws -> (tools: [MCPToolDescriptor], nextCursor: String?) {
...
public actor MCPLiveTestSession {
    ...
    private func listTools(timeout: Duration) async throws -> [MCPToolDescriptor] {
