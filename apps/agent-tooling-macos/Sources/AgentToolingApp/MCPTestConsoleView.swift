...
final class MCPTestConsoleModel {
    ...
    func run(tool: MCPToolDescriptor, arguments: [String: JSONValue]) {
...
private struct MCPTestConsoleSection: View {
    ...
    private func runConfirmationMessage(_ tool: MCPToolDescriptor) -> String {
...
private struct MCPToolInventoryList: View {
    ...
    private var visibleTools: [MCPToolDescriptor] { Array(tools.prefix(Self.visibleLimit)) }
