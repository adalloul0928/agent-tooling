            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 16) {
                    ...
                    VStack(alignment: .leading, spacing: 12) {
                        ...
                        detailRow("Requested by", value: request.requestedByLabels.joined(separator: ", "))
                    ...
                    if hasSensitiveDetails {
                        VStack(alignment: .leading, spacing: 12) {
                            Label("Local review details", systemImage: "lock.macwindow")
                                .font(.headline)
                            Text("These fields are shown only in the app and are not returned by the integration server.")
                                .font(.caption)
                                .foregroundStyle(.secondary)
